...
namespace GodnestCSGOTool
{
    static class lobby
    {
        ...
        static public void joininlobby(string cfgname)
        {
            ...
            statusteam = "Connecting to incentives ...";
        ...
        static public void GetLobbys()
        {
            ...
            while (mainform.autoparser == true)
            {
                ...
                {
                    statusteam = "I download a lobby with " + vkpubs[i].ToString() + "...";
                    ...
                    if (File.ReadAllText("accestoken.txt") != null)
                    {
                        ...
                        {
                            statusteam = "The key has expired";
                            Thread.Sleep(20000);
                        }
                        else
                        {
                                    ...
                                    if (lobbyID != 0)
                                    {
                                        if (notmuchlobbys.Contains(Convert.ToString(lobbyID)) == false)
                                        {
                                            ...
                                            if (besedka.Contains(Convert.ToString(lobbyID)) != true)
                                            {
                                                ...
                                                statusteam = "Reconnecting:" + lobbyID;
                                                Thread.Sleep(500);
        ...
        static void OnMessageCall(SteamGameCoordinator.MessageCallback callback)
        {
            ...
            {
                statusteam = "Connected to the incentive!";
        ...
        static void OnConnected(SteamClient.ConnectedCallback callback)
        {
            ...
            {
                statusteam = "Could not connect to incentives: {0}" + callback.Result;

                mainform.isjoinlobby = false;
                return;
            }

            statusteam = "I go into the account ..." + username;
        ...
        static void OnDisconnected(SteamClient.DisconnectedCallback callback)
        {
            ...
            statusteam = "Disconnected from the stim, reconnect after 5 seconds ...";
        ...
        static void OnLoggedOn(SteamUser.LoggedOnCallback callback)
        {
            ...
            statusteam = "He went into the account!";
