...
namespace GodnestCSGOTool
{
    ...
    class Otlegacheck
    {
        ...
        static public bool LoadConfig(string configFileName)
        {
            ...
            {
                informationsteam = (String.Format("Can not read the file '{0}': {1}", configFileName, e.Message));
                errorlog(String.Format("Can not read the file '{0}': {1}", configFileName, e.Message));
                return false;
            }
        ...
        static public void logCommend(uint accountID, bool result)
        {
            ...
            {
                report = String.Format(": Like for {0} is not screwed!", accountIDFormat(accountID));
            }
            informationsteam = "Done";
            account account = new account();
        ...
        static public void OnConnected(SteamClient.ConnectedCallback callback)
        {
            ...
            informationsteam = (String.Format("Connected to the incentives!"));
        ...
        static public async void OnLoggedOn(SteamUser.LoggedOnCallback callback)
        {
            ...
            switch (callback.Result)
            {
                ...
                case EResult.OK:
                    ...
                    break;
                default:
                    informationsteam = (String.Format("Can not connect to incentives: {0} / {1}", callback.Result, callback.ExtendedResult));
                    errorlog(Config.SteamLogin + String.Format(":Can not connect to incentives: {0} / {1}", callback.Result, callback.ExtendedResult));
                    return;
            }
        ...
        static public string getmsgemail(string Steamlogin)
        {
            using (Pop3 pop3 = new Pop3())
            {
                ...
                errorlog("I can not find the letter!");
                return null;
            }
        }
        ...
        static async void OnClientWelcome(IPacketGCMsg packetMsg)
        {
            ...
            informationsteam = (String.Format("Matchmaking welcomes us. Location: {0}", msg.Body.location.country));
        ...
        {
            informationsteam = (String.Format("Laykayu {0} ...", accountID));
        ...
        static public void OnLoginKey(SteamUser.LoginKeyCallback callback)
        {
            ...
            informationsteam = (String.Format("Updating the key ... you're done!"));
        }
